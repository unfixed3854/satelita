 ...
 * all. `--signal` and `--signal-warn` (green 148, amber 75) are what the
 * rest of the app already uses for live readouts; `--signal-alt` (cyan 220)
 * was added alongside this feature so NOAA-19 would have a third distinct,
 * visible hue. */
